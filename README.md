...
![Image of Checkers](http://img4.hostingpics.net/pics/440764checkers.png)
 
**Contributors:**
 
 * Alexandre Mouquet (@alexmouquet)
 * Clément Porte (@porrto)
 * Théophile Requillart (@theophilereq)

## How to launch

To launch this project, you must have Firefox 44, 43, 38 or 31, according to the compatibility of the Selenium version, specified in 'pom.xml'.
