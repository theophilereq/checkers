	...
	<div class="main container">
		...
		<div class="row">
			<c:if test="${game.winner != null}">
				<div id="div-winner"
					class="col-md-2 col-md-offset-4 col-xs-offset-3">
					<div id="winner"
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<div style="display: none" id="emptyCell"
					class="alert alert-warning alert-dismissible fade in" role="alert">
						...
						<div id="checkers" class="column">
							<c:forEach items="${col.cells}" var="cell">
								<div id="boxGame" class="row">
									<a id="${col.index},${cell.index}"
										onclick="selectCell(${col.index},${cell.index},'${cell.cssColor}','${game.turn}')"
										class="massive circular ui icon ${cell.cssColor}  button"></a>
								</div>
							</c:forEach>
						</div>
					</c:forEach>
		...
		<div class="row">
			<div class="col-md-3 col-md-offset-3 col-sm-6 col-xs-6">
				<div id="turn"
					class="massive circular ui icon ${game.turn} button large">Turn</div>
			</div>
			<div class="col-md-3 col-sm-6 col-xs-6">
				<a href="?reset" class="massive circular icon ui red button"
					id="reset">Reset game</a>
			</div>
		</div>
	</div>
</body>
